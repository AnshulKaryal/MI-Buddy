    ...
    return (
        <div>
            <div className="flex flex-col justify-center items-center my-20 space-y-4">
                ...
                <div>
                    <p className="font-int font-bold text-[40px]">For Any Query, Let Me Help You</p>
                </div>
                <div className="w-[50%] flex flex-col gap-2">
                    ...
                    <button className="font-int font-semibold text-[20px] text-white py-2 rounded-md bg-[#49108B]">Send Message</button>
                </div>
            </div>
        </div>
    );
